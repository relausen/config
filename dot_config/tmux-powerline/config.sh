...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/zc/mm79nfk17vj_4qmdz260t18w0000gp/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/dkRunLau/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/dkRunLau/.mailcheckrc"
# }
